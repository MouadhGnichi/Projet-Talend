...
public class dim_temps implements TalendJob {
	...
	public static class outStruct implements routines.system.IPersistableRow<outStruct> {
		final static byte[] commonByteArrayLock_PI_dim_temps = new byte[0];
		static byte[] commonByteArray_PI_dim_temps = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_dim_temps.length) {
					if (length < 1024 && commonByteArray_PI_dim_temps.length == 0) {
						commonByteArray_PI_dim_temps = new byte[1024];
					} else {
						commonByteArray_PI_dim_temps = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_dim_temps, 0, length);
				strReturn = new String(commonByteArray_PI_dim_temps, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_dim_temps) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:SveUG1uLFeIJtvJBVz0eFbXgCcNN15O9ZeQ0jg==");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("pidatabase", null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equalsIgnoreCase("temps")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_temps` INT(10)   not null ,`InvoiceDate` DATETIME ,`annee` VARCHAR(0)  ,`mois` VARCHAR(0)  ,`jours` VARCHAR(0)  ,primary key(`id_temps`))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "temps" + "` WHERE `id_temps` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "temps"
						+ "` (`id_temps`,`InvoiceDate`,`annee`,`mois`,`jours`) VALUES (?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE `" + "temps"
						+ "` SET `InvoiceDate` = ?,`annee` = ?,`mois` = ?,`jours` = ? WHERE `id_temps` = ?";
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:3UIpLWadF5aeYfIvD1e3Zs5SP8ZlXq8oW2uCIQ==");
				...
				Object source_tFileInputExcel_1 = "E:/business Analytics 1/S2/projet integré/date.xlsx";
											...
											if (row_tFileInputExcel_1
													...
													&& org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(
															row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1
																	+ start_column_tFileInputExcel_1))) {
												row1.InvoiceDate = row_tFileInputExcel_1.getCell(
												...
												if (tempDate_tFileInputExcel_1
													...
													row1.InvoiceDate = tempDate_tFileInputExcel_1;
												}
											}
...
// # Output table : 'out'
									out_tmp.id_temps = Numeric.sequence("s1", 1, 1);
									out_tmp.InvoiceDate = row1.InvoiceDate;
									out_tmp.annee = TalendDate.formatDate("yyyy", row1.InvoiceDate);
									out_tmp.mois = TalendDate.formatDate("MM", row1.InvoiceDate);
									out_tmp.jours = TalendDate.formatDate("dd", row1.InvoiceDate);
									out = out_tmp;
// ###############################
...
// Start of branch "out"
								if (out != null) {
									...
									pstmt_tDBOutput_1.setInt(1, out.id_temps);
									...
									if (checkCount_tDBOutput_1 > 0) {
										if (out.InvoiceDate != null) {
											date_tDBOutput_1 = out.InvoiceDate.getTime();
										...
										if (out.annee == null) {
											...
											pstmtUpdate_tDBOutput_1.setString(2, out.annee);
										}

										if (out.mois == null) {
											pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tDBOutput_1.setString(3, out.mois);
										}

										if (out.jours == null) {
											pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tDBOutput_1.setString(4, out.jours);
										}

										pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, out.id_temps);
										...
										pstmtInsert_tDBOutput_1.setInt(1, out.id_temps);
										...
										if (out.annee == null) {
											...
											pstmtInsert_tDBOutput_1.setString(3, out.annee);
										}

										if (out.mois == null) {
											pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tDBOutput_1.setString(4, out.mois);
										}

										if (out.jours == null) {
											pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tDBOutput_1.setString(5, out.jours);
										}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_temps.class.getClassLoader()
					.getResourceAsStream("pi/dim_temps_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 63519 characters generated by Talend Open Studio for Data Integration on the
 * April 23, 2022 11:07:43 PM WAT
 ************************************************************************************************/