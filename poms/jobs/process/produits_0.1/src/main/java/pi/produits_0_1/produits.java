 ...
 * @status
 */
public class produits implements TalendJob {
	...
	private final String jobName = "produits";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(produits.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class OUTStruct implements routines.system.IPersistableRow<OUTStruct> {
		final static byte[] commonByteArrayLock_PI_produits = new byte[0];
		static byte[] commonByteArray_PI_produits = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_produits.length) {
					if (length < 1024 && commonByteArray_PI_produits.length == 0) {
						commonByteArray_PI_produits = new byte[1024];
					} else {
						commonByteArray_PI_produits = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_produits, 0, length);
				strReturn = new String(commonByteArray_PI_produits, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_produits) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbProperties_tDBOutput_1 == null || dbProperties_tDBOutput_1.trim().length() == 0) {
					url_tDBOutput_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "pidatabase" + "?"
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:4Wc/368Pvq3waLkaAuyGFwrQ5e3AF94EltX6aA==");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("pidatabase", null, null,
						new String[] { "TABLE" })) {
					while (rsTable_tDBOutput_1.next()) {
						String table_tDBOutput_1 = rsTable_tDBOutput_1.getString("TABLE_NAME");
						if (table_tDBOutput_1.equalsIgnoreCase("produits")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_produits` INT(10)   not null ,`InvoiceNo` INT(6)  ,`StockCode` VARCHAR(6)  ,`Description` VARCHAR(35)  ,`UnitPrice` VARCHAR(4)  ,`categories` VARCHAR(10)  ,primary key(`id_produits`))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "produits" + "` WHERE `id_produits` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "produits"
						+ "` (`id_produits`,`InvoiceNo`,`StockCode`,`Description`,`UnitPrice`,`categories`) VALUES (?,?,?,?,?,?)";

				java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(insert_tDBOutput_1);
				resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
				String update_tDBOutput_1 = "UPDATE `" + "produits"
						+ "` SET `InvoiceNo` = ?,`StockCode` = ?,`Description` = ?,`UnitPrice` = ?,`categories` = ? WHERE `id_produits` = ?";
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:d6fDUucNfBBfbVnnKJmoI0kGJIczdpe/ukloYQ==");
				...
				Object source_tFileInputExcel_1 = "E:/business Analytics 1/S2/projet integré/produits.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "InvoiceNo";

									row1.InvoiceNo = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "StockCode";

									row1.StockCode = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.StockCode = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "UnitPrice";

									row1.UnitPrice = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.UnitPrice = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "categories";

									row1.categories = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
...
// # Output table : 'OUT'
									OUT_tmp.id_produits = Numeric.sequence("s1", 1, 1);
									OUT_tmp.InvoiceNo = row1.InvoiceNo;
									OUT_tmp.StockCode = row1.StockCode;
									OUT_tmp.Description = row1.Description;
									OUT_tmp.UnitPrice = row1.UnitPrice;
									OUT_tmp.categories = row1.categories;
									OUT = OUT_tmp;
// ###############################
...
// Start of branch "OUT"
								if (OUT != null) {
									...
									pstmt_tDBOutput_1.setInt(1, OUT.id_produits);
									...
									if (checkCount_tDBOutput_1 > 0) {
										if (OUT.InvoiceNo == null) {
											pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
										} else {
											pstmtUpdate_tDBOutput_1.setInt(1, OUT.InvoiceNo);
										}

										if (OUT.StockCode == null) {
											pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tDBOutput_1.setString(2, OUT.StockCode);
										}

										if (OUT.Description == null) {
											pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tDBOutput_1.setString(3, OUT.Description);
										}

										if (OUT.UnitPrice == null) {
											pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tDBOutput_1.setString(4, OUT.UnitPrice);
										}

										if (OUT.categories == null) {
											pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tDBOutput_1.setString(5, OUT.categories);
										}

										pstmtUpdate_tDBOutput_1.setInt(6 + count_tDBOutput_1, OUT.id_produits);
										...
										pstmtInsert_tDBOutput_1.setInt(1, OUT.id_produits);

										if (OUT.InvoiceNo == null) {
											pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
										} else {
											pstmtInsert_tDBOutput_1.setInt(2, OUT.InvoiceNo);
										}

										if (OUT.StockCode == null) {
											pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tDBOutput_1.setString(3, OUT.StockCode);
										}

										if (OUT.Description == null) {
											pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tDBOutput_1.setString(4, OUT.Description);
										}

										if (OUT.UnitPrice == null) {
											pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tDBOutput_1.setString(5, OUT.UnitPrice);
										}

										if (OUT.categories == null) {
											pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tDBOutput_1.setString(6, OUT.categories);
										}
...
// ###############################      
	...
	public static void main(String[] args) {
		final produits produitsClass = new produits();

		int exitCode = produitsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = produits.class.getClassLoader()
					.getResourceAsStream("pi/produits_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = produits.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : produits");
		}
...
/************************************************************************************************
 * 66423 characters generated by Talend Open Studio for Data Integration on the
 * April 23, 2022 11:20:35 PM WAT
 ************************************************************************************************/